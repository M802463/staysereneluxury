...
<nav id="header">
        ...
        <div class="top flex-between">
            ...
            <div class="top-bar-right">
                <ul>
                    ...
                    <li><i class="fa-solid fa-images"></i>
                        <a href="#">Gallery</a>
                    </li>
    ...
    <section>
        <div class="top flex-between">
            <a href="#" id="logo">
                <img src="assets/images/logo.png" alt="logo" class="img" loading="lazy">
            </a>
            <div class="flex">
                <div class="menu">
        ...
        <div class="menu-cover">
            ...
            <div class="menu-list">
                <ul>
                    ...
                    <li><a href="#"><i class="fa-solid fa-chevron-right"></i> Facilities</a></li>
                    <li><a href="#"><i class="fa-solid fa-chevron-right"></i> Contact</a></li>
                    <li><a href="#"><i class="fa-solid fa-chevron-right"></i> Gallery</a></li>
                    <li><a href="#"><i class="fa-solid fa-chevron-right"></i> Rules and Regulation</a></li>
                    <li><a href="#"><i class="fa-solid fa-chevron-right"></i> Cancellation Policy</a></li>
